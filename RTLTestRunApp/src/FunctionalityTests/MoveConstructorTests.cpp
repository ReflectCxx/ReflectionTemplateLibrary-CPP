    ...
    {
        {
            ...
            auto [err0, calender0] = classCalender->ctorT()(alloc::Stack);
    ...
    {
        {
            ...
            // Create a stack-allocated object via reflection
            auto [err0, calender0] = classCalender->ctorT()(alloc::Heap);
    ...
    {
        {
            ...
            // Create a stack-allocated object via reflection
            auto [err, calender] = classCalender->ctorT()(alloc::Stack);
