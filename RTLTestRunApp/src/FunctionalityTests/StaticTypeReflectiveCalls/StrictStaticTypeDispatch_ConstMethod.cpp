...
namespace rtl_tests
{
    TEST(StrictStaticTypeRtl_const_method, overload_resolution_with_known_signatures)
    {
        ...
        {
            rtl::method<const StringC, std::string(const char)> reverse_string = reverseString->recordT<const StringC>()
                                                                                               .argsT<const char>()
                                                                                               .returnT<std::string>();
            EXPECT_FALSE(reverse_string);
        } {
            rtl::method<const StringC, std::string(char*)> reverse_string = reverseString->recordT<const StringC>()
                                                                                          .argsT<char*>()
                                                                                          .returnT<std::string>();
            EXPECT_FALSE(reverse_string);
        } {
            rtl::method<StringC, std::string(const char*)> reverse_string = reverseString->recordT<StringC>()
                                                                                          .argsT<const char*>()
                                                                                          .returnT<std::string>();
            EXPECT_FALSE(reverse_string);
        } {
            rtl::method<StringC, std::string(std::string)> reverse_string = reverseString->recordT<StringC>()
                                                                                          .argsT<std::string>()
                                                                                          .returnT<std::string>();
            EXPECT_FALSE(reverse_string);
        } {
            ...
            auto exp_str = std::string(STRA_REVERSE) + SUFFIX_ARG_const_char_ptr + SUFFIX_const;
            EXPECT_EQ(ret_str, exp_str);
        } {
            rtl::method<const StringC, std::string(std::string)> reverse_string = reverseString->recordT<const StringC>()
                                                                                                .argsT<std::string>()
                                                                                                .returnT<std::string>();
            ASSERT_TRUE(reverse_string);

            std::string ret_str = reverse_string(StringC())(STRB);
            auto exp_str = std::string(STRB_REVERSE) + SUFFIX_ARG_std_string + SUFFIX_const;
            EXPECT_EQ(ret_str, exp_str);
        } {
            rtl::method<const StringC, std::string()> reverse_string = reverseString->recordT<const StringC>()
                                                                                     .argsT<>()
                                                                                     .returnT<std::string>();
            ASSERT_TRUE(reverse_string);

            std::string ret_str = reverse_string(StringC())();
            auto exp_str = std::string(REV_STR_VOID_RET) + SUFFIX_ARG_void + SUFFIX_const;
            EXPECT_EQ(ret_str, exp_str);
        }
    }
    ...
    TEST(StrictStaticTypeRtl_const_method, lvalue_ref_overload_resolution_with_known_signatures)
    {
        ...
        ASSERT_TRUE(reverseString);
        {
            ...
            auto exp_str = std::string(STRA_REVERSE) + SUFFIX_ARG_std_string_lvref + SUFFIX_const;
            EXPECT_EQ(ret_str, exp_str);
        } {
            rtl::method<const StringC, std::string(const std::string&)> reverse_string = reverseString->recordT<const StringC>()
            ...
            std::string ret_str = reverse_string(target)(lv_str);
            auto exp_str = std::string(STRA_REVERSE) + SUFFIX_ARG_std_string_clvref + SUFFIX_const;
            EXPECT_EQ(ret_str, exp_str);
        }
    }
    ...
    TEST(StrictStaticTypeRtl_const_method, rvalue_ref_overload_resolution_with_known_signatures)
    {
        ...
        ASSERT_TRUE(reverseString);
        {
            ...
            auto exp_str = std::string(STRA_REVERSE) + SUFFIX_ARG_std_string_rvref + SUFFIX_const;
            EXPECT_EQ(ret_str, exp_str);
        } {
            rtl::method<const StringC, std::string(const std::string&&)> reverse_string = reverseString->recordT<const StringC>()
                                                                                                        .argsT<const std::string&&>()
    ...
    TEST(StrictStaticTypeRtl_const_method, ptr_and_const_ptr_overload_resolution_with_known_signatures)
    {
        ...
        ASSERT_TRUE(reverseString);
        {
            ...
            auto exp_str = std::string(STRA_REVERSE) + SUFFIX_ARG_std_string_ptr + SUFFIX_const;
            EXPECT_EQ(ret_str, exp_str);
        } {
            rtl::method<const StringC, std::string(const std::string*)> reverse_string = reverseString->recordT<const StringC>()
                                                                                                       .argsT<const std::string*>()
            ...
            std::string ret_str = reverse_string(target)(&str);
            auto exp_str = std::string(STRA_REVERSE) + SUFFIX_ARG_std_string_cptr + SUFFIX_const;
            EXPECT_EQ(ret_str, exp_str);
        }
    }
    ...
    TEST(StrictStaticTypeRtl_const_method, std_string_method_call_with_known_signature)
    {
        ...
        {
            rtl::method<std::string, bool()> is_empty = isStringEmpty->recordT<std::string>()
                                                                      .argsT<>()
                                                                      .returnT<bool>();
            EXPECT_FALSE(is_empty);
        } {
            rtl::method<const std::string, bool()> is_empty = isStringEmpty->recordT<const std::string>()
                                                                            .argsT<>()
                                                                            .returnT<bool>();
    ...
    TEST(StrictStaticTypeRtl_const_method, std_string_view_method_call_with_known_signature)
    {
        ...
        ASSERT_TRUE(isStringEmpty);
        {
            rtl::method<std::string_view, bool()> is_empty = isStringEmpty->recordT<std::string_view>()
                                                                           .argsT<>()
                                                                           .returnT<bool>();
            EXPECT_FALSE(is_empty);
        } {
            rtl::method<const std::string_view, bool()> is_empty = isStringEmpty->recordT<const std::string_view>()
                                                                                 .argsT<>()
                                                                                 .returnT<bool>();
            ASSERT_TRUE(is_empty);
    ...
    TEST(StrictStaticTypeRtl_const_method, distinct_functions_with_ref_args_call_with_known_signature)
    {
        ...
        std::string str = STRA;
        {
            ...
            rtl::method<const StringC, std::string(const std::string_view&)> reverse_string = reverseString->recordT<const StringC>()
                                                                                                            .argsT<const std::string_view&>()
                                                                                                            .returnT<std::string>();
            ASSERT_TRUE(reverse_string);

            std::string ret_str = reverse_string(target)(str);
            auto exp_str = std::string(STRA_REVERSE) + SUFFIX_ARG_std_string_view_clvref + SUFFIX_const;
            EXPECT_EQ(ret_str, exp_str);
        } {
            std::optional<rtl::Method> reverseString = optStringUtil->getMethod(str_revStrNonConstRefArg);
            ASSERT_TRUE(reverseString);

            rtl::method<const StringC, std::string(std::string_view&)> reverse_string = reverseString->recordT<const StringC>()
            ...
            auto exp_str = std::string(STRA_REVERSE) + SUFFIX_ARG_std_string_view_lvref + SUFFIX_const;
            EXPECT_EQ(ret_str, exp_str);
        } {
            ...
            auto exp_str = std::string(STRA_REVERSE) + SUFFIX_ARG_std_string_view_rvref + SUFFIX_const;
            EXPECT_EQ(ret_str, exp_str);
        }
    }
    ...
    TEST(StrictStaticTypeRtl_const_method, overloads_with_ref_and_value_args_call_with_known_signature)
    {
        ...
        ASSERT_TRUE(reverseString);
        {
            ...
            auto exp_str = std::string(STRA_REVERSE) + SUFFIX_ARG_std_string_view + SUFFIX_const;
            EXPECT_EQ(ret_str, exp_str);
        } {
            rtl::method<const StringC, std::string(std::string_view&)> reverse_string = reverseString->recordT<const StringC>()
                                                                                                      .argsT<std::string_view&>()
