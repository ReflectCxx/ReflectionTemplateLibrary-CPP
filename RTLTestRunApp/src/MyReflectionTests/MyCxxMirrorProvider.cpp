...
namespace my_type
{
    const rtl::CxxMirror& MyReflection()
    {
        ...
        */  rtl::type().record<Person>("Person").build(),
        ...
        //  rtl::type().member<Person>().constructor<Person&&>().build(), // Move constructor, will not compile.
        ...
        */ rtl::type().member<Person>().methodStatic("getDefaults").build(&Person::getDefaults),
        ...
        */ rtl::type().member<Person>().method("updateAddress").build(&Person::updateAddress),
        ...
        /*  Registering a const member-function.
            ...
            See test case: `const_based_overload_resolution_semantics__on_true_const_target` &
                           `const_based_overload_resolution_semantics__on_logical_const_target`
        */ rtl::type().member<Person>().methodConst("updateAddress").build(&Person::updateAddress),
        ...
        */  rtl::type().member<Person>().method("setTitle").build(&Person::setTitle),
        ...
        */  rtl::type().member<Person>().method<std::string&&>("setOccupation").build(&Person::setOccupation),
        ...
        /*  Registers the other overloaded version of `setOccupation` that accepts a const-lvalue-reference (`const std::string&`).
            ...
            For overload resolution, see test case: `perfect_forwarding_semantics__overload_resolution`.
        */  rtl::type().member<Person>().method<const std::string&>("setOccupation").build(&Person::setOccupation),
        ...
        */  rtl::type().member<Person>().methodConst("getProfile").build(&Person::getProfile),
        });
