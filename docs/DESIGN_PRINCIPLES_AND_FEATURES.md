...
By requiring explicit materialization, RTL produces lightweight, reusable functor that behave like ordinary value-type objects and can be stored in standard containers.
