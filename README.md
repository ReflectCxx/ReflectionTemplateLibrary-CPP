...
* ***Non-Intrusive & Macro-Free*** – Reflection metadata is registered externally, without macros, base classes, or intrusive user-type annotations. Registration boilerplate is required and can be generated by *[clang-mirror](https://github.com/ReflectCxx/clang-mirror)*.

* ***Hot-Loop Ready*** – Typed reflection calls exhibit near-zero overhead and scale like direct calls, making RTL suitable for performance-critical and tight-loop workloads. check out *[Performance Summary](docs/benchmark_summary.md)*
