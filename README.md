...
* ***Non-Intrusive & Macro-Free*** – Metadata is registered externally, without macros, base classes, or intrusive user-type annotations. Registration boilerplate is required and can be generated by [clang-mirror](https://github.com/ReflectCxx/clang-mirror).
