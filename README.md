...
RTL is implemented as a static library using type-safe function-pointer tables (internally wrapped in lambdas), providing constant-time `O(1)` lookup and efficient runtime access.
