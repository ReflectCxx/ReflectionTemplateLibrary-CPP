...
* ***Non-Intrusive & Macro-Free*** – No macros, base classes, or intrusive user-type annotations.
  ...
  Registration boilerplate is required and can be generated by [clang-mirror](https://github.com/ReflectCxx/clang-mirror).

* ***Hot-Loop Ready*** – Suitable for performance-critical and tight-loop workloads as well.
