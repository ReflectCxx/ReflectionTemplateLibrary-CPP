...
namespace rtl {
    ...
    *   type().nameSpace("std").record<std::string>("string").methodConst("empty").build(&std::string::empty),
    ...
    *   type().nameSpace("std").record<std::string_view>("string").methodConst("empty").build(&std::string::empty);
