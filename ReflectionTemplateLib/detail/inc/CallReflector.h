...
namespace rtl {
    ...
    */  template<class _derivedType>
        ...
        */  template<class ..._params>
            static Return forwardCall(rtl::alloc&& pAllocType, std::size_t pFunctorIndex, _params&&..._args)
            {
                //'getFunctors()' must be implemented by _derivedType (FunctorContainer).
                return _derivedType::getFunctors().at(pFunctorIndex)(std::forward<rtl::alloc>(pAllocType), std::forward<_params>(_args)...);
            }
