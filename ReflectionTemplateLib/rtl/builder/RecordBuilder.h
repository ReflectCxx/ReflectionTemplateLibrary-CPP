...
*/  template<class record_t>
    ...
    */  constexpr const Builder<detail::member::Static> methodStatic(const std::string& pFunction) const
        {
    ...
    */  template<class ...signature_t>
        constexpr const Builder<detail::member::Static, signature_t...> methodStatic(const std::string& pFunction) const
        {
    ...
    */  constexpr const Builder<detail::member::NonConst> method(const std::string& pFunction) const
        {
    ...
    */  constexpr const Builder<detail::member::Const> methodConst(const std::string& pFunction) const
        {
    ...
    /*  @method: method()
        ...
        * compiler error on 'build(..)' if const, static member or non-member function pointer is passed.
    */  template<class ...signature_t>
        constexpr const Builder<detail::member::NonConst, signature_t...> method(const std::string& pFunction) const
        {
    ...
    */  template<class ...signature_t>
        constexpr const Builder<detail::member::Const, signature_t...> methodConst(const std::string& pFunction) const
        {
