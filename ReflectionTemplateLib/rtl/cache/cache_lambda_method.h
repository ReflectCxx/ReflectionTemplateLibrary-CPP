...
namespace rtl::cache
{
    ...
    struct lambda_method
    {
        ...
        {
            m_erasure_cache.push_back(dispatch::aware_hopper_rec<record_t, return_t, signature_t...>(p_functor));
    ...
    private:
        ...
        mutable std::list<dispatch::aware_hopper_rec<record_t, return_t, signature_t...>> m_erasure_cache;
