...
namespace rtl::cache
{
    ...
    struct lambda_function
    {
        ...
        {
            m_erasure_cache.push_back(erase::aware_function<return_t, signature_ts...>(p_functor));
            m_cache.push_back(dispatch::lambda_function<signature_ts...>(p_functor, m_erasure_cache.back()));
