...
int main() {
    ...
    const auto& icount = std::any_cast<std::reference_wrapper<const unsigned int>>(iret);
    ...
    const auto& ocount = std::any_cast<std::reference_wrapper<const unsigned int>>(oret);
